      ...
      <Section>
        <div className="max-w-md w-full">
          <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg">
            <div className="text-gray-800 text-2xl sm:text-3xl font-bold flex flex-col sm:flex-row items-center justify-center mb-6 gap-4">
              <span>Đăng nhập</span>
              <div className="flex space-x-2">
                <button type="button" className="border-none outline-none p-1">
                  <svg
                ...
                <button type="button" className="border-none outline-none p-1">
                  ...
                  >
                    <path
                      fill="#1877f2"
                      d="M512 256c0 127.78-93.62 233.69-216 252.89V330h59.65L367 256h-71v-48.02c0-20.25 9.92-39.98 41.72-39.98H370v-63s-29.3-5-57.31-5c-58.47 0-96.69 35.44-96.69 99.6V256h-65v74h65v178.89C93.62 489.69 0 383.78 0 256 0 114.62 114.62 256 256 256s256 114.62 256 256z"
                    ></path>
                    <path
                      fill="#fff"
            ...
            >
              <div>
                ...
                <div className="relative flex items-center">
                  <input
                    ...
                    type="text"
                    required
                    className="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-lg outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
              ...
              <div>
                <button
                  type="submit"
                  className="w-full py-3 px-4 text-sm font-medium tracking-wide rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
                >
                  Đăng nhập
                </button>
              </div>
